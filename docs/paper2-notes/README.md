...
> **Draft:** [`../papers/paper2-agent-trajectory.md`](../papers/paper2-agent-trajectory.md) (v1 yazıldı, review ile v1.1'e ilerler)
...
> **İlişki:** `docs/roadmap/paper2-roadmap.md` (omurga) → bu dizin (kanıtlar)
...
`docs/spec/invariants.md` — Aşama A kodlamadan ÖNCE INV-T1..T7 + mevcut INV #1..#15'in
...
- **Paper 2 draft v1:** YAZILDI ✍️ — `docs/papers/paper2-agent-trajectory.md` (576 satır, Paper 1 v2.6 mirror).
  Ana tez: task = measurement predicate (INV-T1). Review'larla v1.1'e ilerler.
...
*Bu dizin `docs/roadmap/paper2-roadmap.md` §10 ile uyumludur.*
