...
için draft deposit bekliyor. **~965 workspace test (osp-desktop hariç, CLI: osp-core 538 lib, osp-cli 107 unit + 21 review_flow + 20 supersede_flow + 12 preview_flow + 8 analyze_bridge_flow, osp-mcp +2 INV-C11), 0 development marker, 367 kelime abstract.**
...
- osp-llm-runtime: ~12
- osp-cli: 107 unit (store_io/repository/seed_file/review_session/mapper/preview-builder/canonical-identity/analysis-bridge/graph-seed-builder/metric-projection) + 21 review_flow + 20 supersede_flow + 12 preview_flow + 8 analyze_bridge_flow + 1 architecture_guards integration
- osp-mcp: 8 unit + 7 INV-T1 integration + 2 INV-C11 agent-surface regression
- osp-spike: ~32
- **Toplam: ~965 workspace test (osp-desktop hariç)**, hepsi yeşil. CI warning-only clippy (`|| true`); bu PR 0 yeni uyarı.
