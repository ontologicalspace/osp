...
`AgentTaskView` üretirken koordinatı düşürür. Bu `docs/spec/invariants.md`'de formal
...
**Garanti:** `docs/spec/invariants.md` INV-T1'de formal — AgentTaskView serde'de
...
| 2026-06-30 | spec/invariants.md önceliği | review 1 — kod yazmadan formal invariant spec. |
